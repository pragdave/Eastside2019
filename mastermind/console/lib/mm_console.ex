defmodule MmConsole do
  ...
  defp show_game_and_get_move(%{ won: true }) do
    IO.puts "Congratulations!"
  end

  defp show_game_and_get_move(game = %{ turns_left: 0 }) do
    IO.puts "Sorry. The answer was #{Mastermind.answer(game)}"
  end
  ...
  defp display_help() do
    ...
    I have a bag full of the numbers 1 through 6. There are
    lots of copies of each.

    I've picked 4 numbers. You have to guess them. For example,
